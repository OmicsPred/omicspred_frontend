...
function Footer() {
    ...
    <footer className="d-flex flex-wrap justify-content-between align-items-center px-5 py-4 mt-auto border-top bg-light">
        <div className="col-md-4 d-flex align-items-center" style={{verticalAlign:'middle'}}>
            <Href icon={<Building />} text="Lab's website" href="http://www.inouyelab.org/" no_external_icon="1" />
           </div>

        <div className="col-md-4 d-flex align-items-center">
            <Href icon={<CCircleFill />} text="All Genetics Scores are provided under a CC-BY license" href="http://www.inouyelab.org/" no_external_icon="1" />
        </div>
