...
import { Note, TooltipText } from '../../components/Generic';
		...
		'Genetic Score': {
			...
			'text': <div>
						...
						<div className="mt-4">
							...
							<div>
								<Note msg={<>PLINK2 is not compatible with the file header (lines starting with the characer <code>#</code>), therefore these lines need to be removed from the {project_name} genetic score files before running the PLINK2 command.</>} />
							</div>
						</div>
					</div>
		},
