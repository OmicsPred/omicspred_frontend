...
function ScoresTest() {
    ...
    const handleIDInput = async (event) => {
        ...
        // if (event.target.value.length > 9) { // OPGSXXXXXX
                ...
                { platforms && omicsTypes && publications && tissues ?
                    <div className='d-flex mb-2'>
                        <div className="card p-0 me-3">
                            {/* <div className="card-header"><h6 className="mb-0"><Sliders className='me-2 align-top'/><span className='align-top'>Scores filter</span></h6></div> */}
                                ...
                                <div className="card-text">
                                    <div className='op_filter_container_3'>
                                        ...
                                        <div className='compact_form'>
                                            ...
                                            {/* <div>
                                                <FormControl sx={{ minWidth: 150 }} size="small">
                                                    <InputLabel id="select_publication_label">Publication</InputLabel>
                                                    <Select
                                                        labelId="select_publication_label"
                                                        id="select_publication"
                                                    ...
                                                    >
                                                        ...
                                                        {Object.keys(publications).map((opp_id) => <MenuItem key={opp_id+'_sel'} value={opp_id}>{publications[opp_id]}</MenuItem>)}
                                                    </Select>
                                                </FormControl>
                                            </div> */}
                                            {/* <div>
                                                <FormControl sx={{ minWidth: 150 }} size="small">
                                                    <InputLabel id="select_platform_label">Platform</InputLabel>
                                                    <Select
                                                        labelId="select_platform_label"
                                                        id="select_platform"
                                                    ...
                                                    >
                                                        <MenuItem key='none_sel' value=''>-</MenuItem>
                                                        {Object.keys(platforms).sort().map((platform) => <MenuItem key={platform+'_sel'} value={platform}><Stack size="0.9em" className={"align-middle me-2 color_"+platforms[platform]}/> {platform}</MenuItem>)}
                                            ...
                                            {/* <div>
                                                <FormControl sx={{ minWidth: 150 }} size="small">
                                                    <InputLabel id="select_omics_type_label">Omics type</InputLabel>
                                                    <Select
                                                        labelId="select_omics_type_label"
                                                        id="select_omics_type"
                                                    ...
                                                    >
                                                        <MenuItem key='none_sel' value=''>-</MenuItem>
                                                        {omicsTypes.map((o_type) => <MenuItem key={o_type+'_sel'} value={o_type}><BoxFill className={"align-middle me-2 color_"+o_type}/> {o_type}</MenuItem>)}
                                                    </Select>
                                                </FormControl>
                                            </div> */}
                                            {/* <div>
                                                <FormControl sx={{ minWidth: 150 }} size="small">
                                                    <InputLabel id="select_tissue_label">Tissue</InputLabel>
                                                    <Select
                                                        labelId="select_tissue_label"
                                                        id="select_tissue"
                                                    ...
                                                    >
                                                        <MenuItem key='none_sel' value=''>-</MenuItem>
                                                        {tissuesLabels.map((tissue_label) => <MenuItem key={tissues[tissue_label]+'_sel'} value={tissues[tissue_label]}>{tissue_label}</MenuItem>)}
                                                    </Select>
                                                </FormControl>
                                            </div> */}
                                            {/* <div>
                                        ...
                                        <div className='compact_form'>
                                            ...
                                            {/* radio_form = (label,selection,items_data,handleChange) => { */}
                                            ...
                                            {/* <div>
                                                <FormControl sx={{ minWidth: 150 }} size="small">
                                                    ...
                                                    <RadioGroup
                                                        ...
                                                        size="small"
                                                    >
                                                        <FormControlLabel value="Gene" control={<Radio />} label={<><Hexagon className={"align-middle me-1 color_gene"}/><span className="align-middle">Gene</span></>} size="small"/>
                                                        <FormControlLabel value="Protein" control={<Radio />} label={<><Hexagon className={"align-middle me-1 color_protein"}/><span className="align-middle">Protein</span></>} size="small"/>
                                                        <FormControlLabel value="Metabolite" control={<Radio />} label={<><Hexagon className={"align-middle me-1 color_metabolite"}/><span className="align-middle">Metabolite</span></>} size="small"/>
                                                    </RadioGroup>
                                                </FormControl>
                                            </div> */}
                                            <div className='no_mt'>
