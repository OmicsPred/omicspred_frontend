...
//   const tissue_badge = (platform_cat, tissue, index) => {
//         return <a key={platform_cat.name+'-'+tissue.id} href={'tissue/'+tissue.id} className={index == 0 ? 'badge bg_tissue' : 'badge bg_tissue ms-1'}>{tissue.label}</a>
//   }
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="card-text">
                                            ...
                                            <span className={'badge bg_'+platform_cat.o_type+' me-2'}>{platform_cat.o_type}</span>{display_tissues(platform_cat, platform_cat.tissues)}
                                                {/* <span className={'badge bg_'+platform_cat.o_type+' me-2'}>{platform_cat.o_type}</span>{platform_cat.tissues.map((tissue) => <span key={platform_cat.name+'-'+tissue} className='badge text-bg-dark'>{tissue}</span>)} */}
                                            </div>
                                        </div>
