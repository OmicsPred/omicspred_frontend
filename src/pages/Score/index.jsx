...
function Score() {
    ...
    const phenotype_cols_ids = ['phenotypes__id','sample__sample_number','data_values__FDR'];
                    ...
                    <div>
                        ...
                        { scorePhenotypeData && scorePhenotypeData.length ?
                            <div className='mt-5' id="phenotype_table">
                                ...
                                <DataTable key="phenotype" data={scorePhenotypeData} columns={phenotype_score_cols} col_for_ids={phenotype_cols_ids} sorting='phenotype_name' hidden_columns={['sample__ancestry_broad']}/>
                            </div>:''
                        }
                    </div>
                </>
