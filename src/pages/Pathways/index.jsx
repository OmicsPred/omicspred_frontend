...
function Pathways() {
    ...
    const url_endpoint = 'pathway/all?include_counts=0'
    ...
    return (
        <>
            ...
            <div>
                Browse the Reactome pathways that have been mapped to the {process.env.PROJECT_NAME} Molecular traits (source: <Href text={reactome_link_text()} href='https://reactome.org/download-data' />).
            </div>
            <div className="mt-4">
